...
if (!(marker instanceof HTMLElement)) {
    ...
    div.innerHTML = `<p>First, log into the <a href="https://forums.e-hentai.org/index.php?act=Login&CODE=00" target="_blank" style="color: #44a4f4;">E-Hentai Forums.</a><p>
     <p>After a successful login, <span style="color:red">REFRESH</span> this page.</p>
     <p>If you\'re lucky, you can get into ExHentai.</p>
     <p>Clearing your cookies may help you solve some problems.</p>
     <p id="msg" />`
